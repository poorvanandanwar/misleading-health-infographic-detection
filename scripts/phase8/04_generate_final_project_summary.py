...
SUMMARY_PATH = OUTPUT_DIR / "final_project_summary.md"


if not REPORT_PATH.exists():
    print("ERROR: Updated research report not found.")
    print(REPORT_PATH)
    raise SystemExit(1)
...
print("=" * 70)
print("PHASE 8D - FINAL PROJECT SUMMARY")
print("=" * 70)
print(f"Summary saved to: {SUMMARY_PATH}")
print(f"Total characters: {len(summary)}")
print(f"Total lines: {len(summary.splitlines())}")
print("Original research report preserved: YES")
print("Phase 8D completed successfully")